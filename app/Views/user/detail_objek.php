...
<body>
    ...
    <section class="blog-details-hero set-bg hero-section" data-setbg="../../../objek_wisata/<?= $imgs->gambar_objek ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bd-hero-text">
                        <h2 class="filtered-text"><?= $data[0]->nama_objek ?></h2>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-pic">
                        ...
                        <div class="blog-more-details">
                            <h4>Foto Pemandangan Di <?= $data[0]->nama_objek ?></h4>
                        </div>
                        <?php foreach ($img as $key => $img) : ?>
                            <?php if ($key === 0) : ?>
                                <div class="bd-pic-item small-item set-bg" data-setbg="../../../objek_wisata/<?= $img->gambar_objek ?>"></div>
                            <?php elseif ($key === 1) : ?>
                                <div class="bd-pic-item small-item set-bg" data-setbg="../../../objek_wisata/<?= $img->gambar_objek ?>"></div>
                            <?php else : ?>
                                <div class="bd-pic-item small-item set-bg" data-setbg="../../../objek_wisata/<?= $img->gambar_objek ?>"></div>
            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="leave-comment p-4">
                    ...
                    <?php if (session('username')) : ?>
                        <form id="commentForm" action="<?= base_url('User/data_review') ?>" method="post">
                            <div class="row">
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="jenis" value="<?= $data[0]->id_objek ?>">
                                        <input type="hidden" class="form-control" name="nama" value="<?= $data[0]->nama_objek ?>">
                                        <input type="hidden" class="form-control" name="tipe" value="objek">

      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Tambah Data Objek Wisata</h4>
                  <form class="forms-sample" action="<?= base_url('Objek_wisata/insert_objek')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label>Upload Gambar Objek WIsata</label>

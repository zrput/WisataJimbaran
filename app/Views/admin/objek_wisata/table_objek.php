                        ...
                        <?php foreach ($data as $datas) : ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-info py-3" data-toggle="modal" data-target="#exampleModals-<?= $datas->id_objek ?>">
                                Detail
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="exampleModals-<?= $datas->id_objek ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="namaRestoran">Nama Objek Wisata:</label>
                                                    <input type="text" id="namaRestoran" class="form-control" value="<?= $datas->nama_objek ?>" readonly>
                                                </div>
                            ...
                            <button type="button" class="btn btn-dark py-3" onclick="location.href='<?= base_url('Objek_wisata/edit_objek'). '/' . $datas->id_objek?>'"><i class="ti-file btn-icon-append"></i>Edit</button>
                            <button type="button" class="btn btn-danger hapus-data py-3" onclick="deleteConfirmation()"><i class="ti-trash btn-icon-append"></i>Delete</button>
                            </td>
                          </tr>
                          <?php $no++; ?>
                        <?php endforeach; ?>
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            location.href='<?= base_url('Objek_wisata/delete_objek'). '/' . $datas->id_objek?>';

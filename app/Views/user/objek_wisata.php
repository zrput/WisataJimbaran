        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <!-- Formulir Pencarian -->
                    <form action="<?= base_url('User/cari_objek') ?>" method="post" class="mb-4">
            ...
            <div class="row">
                <?php foreach ($data as $objek) : ?>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item border rounded p-3" >
                        <div class="sb-pic">
                            <img src="../objek_wisata/<?= $gambarData[$objek->id_objek]; ?>" alt="">
                        </div>
                        <div class="sb-text ms-5">
                            <h4><a href="<?= base_url('User/detail_objek'). '/' . $objek->id_objek . '/' . $objek->nama_objek?>"><?= $objek->nama_objek; ?></a></h4>
                            <h6><?= $objek->alamat; ?></h6>
                        </div>
                    </div>
                </div>

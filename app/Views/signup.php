...
<body>
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                    <div class="card border border-light-subtle rounded-4">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <button class="btn btn-outline-secondary back-button" onclick="location.href='<?= base_url('User/main')?>'"><–</button>
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                            ...
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link <?php echo session('tab') == 'login' ? 'active' : '' ?>" id="pills-login-tab" data-bs-toggle="pill" data-bs-target="#pills-login" type="button" role="tab" aria-controls="pills-login" aria-selected="<?php echo session('tab') == 'login' ? 'true' : 'false' ?>">Login</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link <?php echo session('tab') == 'signup' ? 'active' : '' ?>" id="pills-signup-tab" data-bs-toggle="pill" data-bs-target="#pills-signup" type="button" role="tab" aria-controls="pills-signup" aria-selected="<?php echo session('tab') == 'signup' ? 'true' : 'false' ?>">Sign Up</button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <!-- Login Form -->
                                <div class="tab-pane fade <?php echo session('tab') == 'login' ? 'show active' : '' ?>" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
                                    <?php echo form_open('Auth/cek_login')?>
                                        <div class="row gy-3 overflow-hidden">
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="password" class="form-control <?php echo session('errors.password') ? 'is-invalid' : '' ?>" name="password" id="password" placeholder="Password">
                                ...
                                <!-- Sign Up Form -->
                                <div class="tab-pane fade <?php echo session('tab') == 'signup' ? 'show active' : '' ?>" id="pills-signup" role="tabpanel" aria-labelledby="pills-signup-tab">
                                    <?php echo form_open('Auth/cek_signup'); ?>
                                        <div class="row gy-3 overflow-hidden">
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control <?php echo session('errors.username') ? 'is-invalid' : ''; ?>" name="username" id="username" placeholder="Username" value="<?php echo set_value('username'); ?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="email" class="form-control <?php echo session('errors.emailup') ? 'is-invalid' : ''; ?>" name="emailup" id="email-signup" placeholder="name@example.com" value="<?php echo set_value('emailup'); ?>">
                                                    <label for="email-signup" class="form-label">Email</label>
                                                    <?php if (session('errors.emailup')): ?>
                                                        <div class="invalid-feedback">
                                                            <?php echo session('errors.emailup'); ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="password" class="form-control <?php echo session('errors.passwordup') ? 'is-invalid' : ''; ?>" name="passwordup" id="password-signup" placeholder="Password">
                                                    <label for="password-signup" class="form-label">Password</label>
                                                    <?php if (session('errors.passwordup')): ?>
                                                        <div class="invalid-feedback">
                                                            <?php echo session('errors.passwordup'); ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                                ...
                                                <a href="#!" class="link-secondary text-decoration-none" id="already-account-link">Make Company account?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            const activeTab = "<?php echo session('tab'); ?>";
            if (activeTab) {

      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Tambah Data Menu Restoran</h4>
                  <form class="forms-sample" action="<?= base_url('Menu/insert_menu')?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="nama">Nama Menu</label>
                      <input type="hidden" class="form-control" name="id_restoran" value="<?=$pk?>">
                      <input type="text" class="form-control" name="nama" >
                    </div>

                    <!-- radio button -->
                    <div class="form-group">
                        <label>Pilih Jenis Menu</label>
                        <div class="form-group">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="tipe" id="optionsRadios1" value="makanan">
                              Makanan
                            </label>
                          </div>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="tipe" id="optionsRadios1" Value="minuman">
                              Minuman
                            </label>
                          </div>
                        </div>

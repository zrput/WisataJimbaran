      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Tambah Data Akomodasi Penginapan</h4>
                  <form class="forms-sample" action="<?= base_url('Akomodasi/insert_akomodasi')?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="tipe" id="optionsRadios1" value="Hotel">
                              Hotel
                            </label>
                          </div>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="tipe" id="optionsRadios1" Value="Villa">
                              Villa
                            </label>
                          </div>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="tipe" id="optionsRadios1" value="Homestay">
                              Homestay
                            </label>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nomor" placeholder="08123456789">
                    </div>
                    <div class="form-group">
                      <label for="peta">Link Peta Map</label>
                      <input type="text" class="form-control" name="peta">
                    </div>
                    
                    <div class="form-group">
                      <label>Upload Gambar Penginapan</label>

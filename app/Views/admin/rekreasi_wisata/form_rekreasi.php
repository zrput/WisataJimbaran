      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Tambah Data Tempat Rekreasi Wisata</h4>
                  
                  <form class="forms-sample" action="<?= base_url('Aktifitas_rekreasi/insert_rekreasi')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="jam" placeholder="09:00 AM - 09:00 PM">
                    </div>

                    <div class="form-group">
                      <label for="exampleTextarea1">Harga Tiket Tempat Rekreasi</label>
                      <textarea class="form-control" id="exampleTextarea1" name="harga" rows="4"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      <label>Upload Gambar Tempat Rekreasi</label>

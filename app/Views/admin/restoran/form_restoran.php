      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Tambah Data Restoran</h4>
                  <form class="forms-sample" action="<?= base_url('Restoran/insert_restoran')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="jam">No Telepon Restoran</label>
